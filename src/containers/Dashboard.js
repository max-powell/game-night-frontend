...
class Dashboard extends Component {
  ...
  render() {
    ...
    const { selectFriend, addSentFriendRequest, cancelFriendRequest, addGame, acceptFriendRequest, rejectFriendRequest, acceptEventInvite, rejectEventInvite, leaveEvent } = this
